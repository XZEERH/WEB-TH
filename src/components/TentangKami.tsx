export default function TentangKami() {
  return (
    <div className="max-w-4xl mx-auto space-y-8 flex flex-col items-center animate-fade-in">
      <h1 className="text-4xl md:text-5xl text-black text-center mb-8">Tentang Komunitas TH</h1>
      
      <div className="space-y-6 text-gray-700 text-justify md:text-lg bg-white p-8 md:p-12 rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
        <p>
      ...
      {/* Social Media Links - Hitam */}
      <div className="flex space-x-8 mt-10">
        <a href="https://tiktok.com" target="_blank" rel="noreferrer" className="text-black hover:-translate-y-2 transition-all duration-300">
        ...
        <a href="https://instagram.com" target="_blank" rel="noreferrer" className="text-black hover:-translate-y-2 transition-all duration-300">
          <svg className="w-12 h-12 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
