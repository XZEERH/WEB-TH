export default function TentangKami() {
  return (
    <div className="max-w-4xl mx-auto space-y-8 flex flex-col items-center animate-fade-in">
      <h1 className="text-4xl md:text-5xl text-neonBlue text-center mb-8 drop-shadow-[0_0_10px_rgba(0,240,255,0.5)]">Tentang Komunitas TH</h1>
      
      <div className="space-y-6 text-gray-300 text-justify md:text-lg bg-darkCard p-8 md:p-12 rounded-2xl border border-neonBlue/30 shadow-[0_0_20px_rgba(0,240,255,0.1)]">
        <p>
      ...
      <div className="flex space-x-8 mt-10">
        <a href="https://tiktok.com" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-neonBlue hover:-translate-y-2 transition-all duration-300 drop-shadow-[0_0_10px_rgba(0,240,255,0)] hover:drop-shadow-[0_0_15px_rgba(0,240,255,0.8)]">
        ...
        <a href="https://instagram.com" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-neonBlue hover:-translate-y-2 transition-all duration-300 drop-shadow-[0_0_10px_rgba(0,240,255,0)] hover:drop-shadow-[0_0_15px_rgba(0,240,255,0.8)]">
          <svg className="w-12 h-12 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
