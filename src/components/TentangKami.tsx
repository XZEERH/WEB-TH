  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 flex flex-col items-center animate-fade-in">
      ...
      <div className="flex space-x-6 md:space-x-8 mt-10 flex-wrap justify-center gap-y-4">
        ...
        {/* Instagram */}
        <a href="https://www.instagram.com/teachingofhistory?igsh=MTYxMHcxdmtrZGU1cw==" target="_blank" rel="noreferrer" className="text-black hover:scale-110 transition-transform duration-300">
          <svg className="w-10 h-10 md:w-12 md:h-12 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* WhatsApp */}
        <a href="https://chat.whatsapp.com/DQGMP88lmid5PQVeAGrnij?mode=gi_t" target="_blank" rel="noreferrer" className="text-black hover:scale-110 transition-transform duration-300">
          <svg className="w-10 h-10 md:w-12 md:h-12 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* YouTube */}
        <a href="https://www.youtube.com/@TEACHINGHistory-u8b" target="_blank" rel="noreferrer" className="text-black hover:scale-110 transition-transform duration-300">
          <svg className="w-10 h-10 md:w-12 md:h-12 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
