...
import { db } from '../firebase'; // Memanggil koneksi database lu
      ...
      {selectedCard && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fade-in">
          <div className="bg-white border border-gray-300 rounded-2xl max-w-xl w-full relative overflow-hidden shadow-2xl flex flex-col max-h-[90vh]">
            ...
            <img src={selectedCard.gambar} alt={selectedCard.judul} className="w-full h-64 object-cover flex-shrink-0" />
